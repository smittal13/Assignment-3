...
public class CardDeck {
	...
	//Number of card types, card locations, initial array with cards
	...
	//Deck size, list of Cards, index for cards
	private static final int numCards = 44;
	private final List<Card> cards;
	private int index;
	
	//Map of all the deck numbers
	private static final Map<Integer,Integer> values;
	
	//Initializes all deck numbers
